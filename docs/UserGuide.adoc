...
*A*: You can manually download foodiebot.json file which we have published from  link:https://github.com/AY1920S2-CS2103T-F11-3/main/blob/master/foodiebot.json[here].
